...
# mca
python main.py --dname 'MCA_our' --n_repeat 2 --moco_k 2048 --moco_m 0.999 --moco_t 0.07 \
...
# # # pbmc
# python main.py --dname 'PBMC_our' --n_repeat 2 --moco_k 2048 --moco_m 0.999 --moco_t 0.07 \
#                     --block_level 1 --lat_dim 128 --symmetric True \
#                     --select_hvg 2000 \
#                     --knn 10 --alpha 0.5 --augment_set 'int' \
...
# # pancreas
# python main.py --dname 'Pancreas_our' --n_repeat 2 --moco_k 2048 --moco_m 0.999 --moco_t 0.07 \
#                     --block_level 1 --lat_dim 128 --symmetric True \
#                     --select_hvg 2000 \
#                     --knn 10 --alpha 0.5 --augment_set 'int' \
#                     --lr 1e-4 --optim Adam --weight_decay 1e-5 --epochs 100 --batch_size 256\
